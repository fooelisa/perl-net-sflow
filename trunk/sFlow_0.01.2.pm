...
sub _decodeIpAddress {
  ...
  # unknown ip version added in v5 
  elsif ($IpVersion == UNKNOWNIPVERSION) {
    $error = "ERROR: Unknown ip version: $IpVersion";
    return ($sFlowDatagram, $sFlowSamples, \$error);
  }
...
sub _decodeRouterData {
  ...
  &_decodeIpAddress($sFlowDatagramPacked, $sFlowDatagram, $sFlowSample, $sFlowSamples, 
                    $sFlowSample->{RouterIpVersionNextHopRouter}, "RouterIpAddressNextHopRouter");
...
sub _decodeGatewayData {
  ...
  if ($sFlowDatagram->{sFlowVersion} == SFLOWv5) {
    ...
    &_decodeIpAddress($sFlowDatagramPacked, $sFlowDatagram, $sFlowSample, $sFlowSamples,
                      $sFlowSample->{GatewayIpVersionNextHopRouter}, "GatewayIpVersionNextHopRouter");
  }
...
sub _decodeMplsData {
  ...
  &_decodeIpAddress($sFlowDatagramPacked, $sFlowDatagram, $sFlowSample, $sFlowSamples,
                    $sFlowSample->{MplsIpVersionNextHopRouter}, "MplsIpVersionNextHopRouter");
...
sub _decodeNatData {
  ...
  &_decodeIpAddress($sFlowDatagramPacked, $sFlowDatagram, $sFlowSample, $sFlowSamples,
                    $sFlowSample->{NatIpVersionSrcAddress}, "NatIpVersionSrcAddress");
 
  ($sFlowSample->{NatIpVersionDestAddress}) = unpack("N", $$sFlowDatagramPacked);
  $$sFlowDatagramPacked = substr ($$sFlowDatagramPacked, 4);
 
  &_decodeIpAddress($sFlowDatagramPacked, $sFlowDatagram, $sFlowSample, $sFlowSamples,
                    $sFlowSample->{NatIpVersionDestAddress}, "NatIpVersionDestAddress");
}
